...
from typing import Any, Callable, ClassVar, Dict, Iterable, TextIO, Tuple, Union

from tqdm import tqdm

from arugifa.cli.typing import UpdateErrors, UpdatePlan, UpdateProgress, UpdateResult
